                    ...
                    <h3 CLASS="title1">Stock en Linea</h3></br>
                        ...
                        <table width="500">
                            ...
                            <td width="200"><h4>Nombre Medicamento </h4></td>
                                ...
                                <td><input type="button" value="Buscar" name="btnBuscar" class="btn btn-primary" /></td>
                            </tr></br>
                            <tr>
                                <td width="200" style="text-align: center">Cantidad Disponible</td>
                                <td><input type="text" name="txtMedicamento" class="form-control" style="width:200px;" disabled="" /></td>
                            </tr>
                        </table>
                                </form>

...
<html>
    ...
    <body>
        ...
        <div class="about">
		<div class="container">
			<h3 class="title1">PRE<span>ESCRIPCION</span></h3>
			<div class="about-info">
				...
				<div class="col-md-10 sevcs-grids">
					...
					<div class="contact-form">
                                            <form action="receta.jsp" method="post">  <%-- poner action al servlet --%>
                                                    <table class="table" >
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="date" name="dtFechaAtencion"  required=""></td>
                                                        </tr>
                                                        <tr>
